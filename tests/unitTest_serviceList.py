...
class ll_ATS(unittest.TestCase):
    ...
    def test_ll(self):
        ...
        driver.find_element(By.XPATH, "//a[contains(., 'Services')]").click()
        time.sleep(5)
        try:
            ...
            elem = driver.find_element(By.LINK_TEXT, "Learn More")
            self.driver.close()
            assert True

        except NoSuchElementException:
            driver.close()
            self.fail("Service List does not appear when Services clicked")
